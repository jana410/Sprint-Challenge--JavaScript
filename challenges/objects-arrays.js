...
const contactInfo = [
  "Jana janamlbb@gmail.com",
  "Sherry sherry@yahoo.com",
  "Bob bob@gamil.com",
  "Guin guin@mlbb.com",
  "Claude claude@mlbb.com"
];
...
//console.log(filterNames(universities, "Uni"));
const unisWithUni = [
  "International Medical & Technological University",
  "Salem University",
  "Coastal Carolina University",
...
zooAnimals.forEach(function(currentValue, array) {
...
/*const lowCaseAnimalNames = zooAnimals.map(currentValue =>
  currentValue.animal_name.toLocaleLowerCase()
); */
//console.log(lowCaseAnimalNames);
...
/*for (let i = 0; i < zooAnimals.length; i++) {
  function doSomething() {
    if (zooAnimals[i].population < 5) {
      lowPopulationAnimals.push(zooAnimals[i].animal_name);
    }
  }
  doSomething();
} */
